...
1. COMPLETE - A custom Google font for highlights
2. COMPLETE - A specified standard san-serif web font for data (such as Arial, Verdana, or Helvetica)
3. COMPLETE - A specified standard serif web font for text (such as Georgia, Times, etc.)
4. Specified different font colors for all three font usages
5. COMPLETE - A background color for the default page background (make sure font colors have good contrast and are readable on this background)
6. COMPLETE - A different background color for elements such boxes and tables (so make sure the font colors contrast against this well, too!)
